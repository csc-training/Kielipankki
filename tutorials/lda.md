...
The standard library module {% highlight %} multiprocessing {% endhighlight %} has helpful facilities for this, such as `multiprocessing.Pool`, which can be used to `map` inputs to outputs in parallel.
